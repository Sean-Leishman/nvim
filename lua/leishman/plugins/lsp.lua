return {
	...
	},
	{
		...
		config = function()
			...
			-- `gr` (references) is intentionally NOT mapped: Neovim 0.11 ships a
			-- built-in `grr` for references, and a custom `gr` mapping just shadows
			-- the `gr*` prefix (grr/gra/grn/gri/grt), adding a timeoutlen delay.
